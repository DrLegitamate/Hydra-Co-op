...
Rust and Cargo: Needed to build the project. Install via rustup.rs.
...
Install Rust and Cargo: If you don't have Rust installed, follow the instructions on rustup.rs.

Install Dependencies: Use your distribution's package manager to install GTK 4 and libevdev development libraries as listed in the Requirements section.
...
Set up Permissions: Add your user to the input and uinput groups:
...
Load uinput Module: Ensure the kernel module is loaded as mentioned in the Requirements section.
